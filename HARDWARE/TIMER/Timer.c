...
unsigned int  Timer_Couter=0x00;//用于毫秒计数
unsigned char Timer_Couter_Minute=0x00;//用于计算1分钟
...
//			   LED4_Toggle;
		...
		if(Timer_Couter==1000) //1s，累计1000ms
		{
			IWDG_Feed(); //喂狗	
			Timer_Couter=0;
			Timer_Couter_Minute++;			
