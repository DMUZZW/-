...
//static unsigned short_t fac_ms=0;																										/*ms延时倍乘数*/
...
//	fac_us=sysclk/8;		    
//	fac_ms=(unsigned short_t)fac_us*1000;
//}								    
...
*@return	num:返回转化后的整型数
*/
uint32 atoi32(char* str,unsigned short base	)
{
  uint32 num = 0;
  while (*str !=0)
          num = num * base + c2d(*str++);
...
*@return	无
*/
void itoa(unsigned short n,uint8 str[5], uint8 len)
{
