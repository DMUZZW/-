...
//RTC时间设置函数，用于设置板卡时间——小时、分钟、秒钟 其返回值表示设置是否成功
//RTC时间设置
//hour,min,second:小时,分钟,秒钟
...
//RTC日期设置函数，用于设置板卡日期——年(0-99)、月(1-12)、日(1-31)、星期（1-7，0非法）其返回值表示设置是否成功
...
//    { 
//    Set_Board_RTC_Time(23,59,56,RTC_HOURFORMAT12_PM);	        //设置时间 ,根据实际时间修改
//		Set_Board_RTC_Date(15,12,27,7);		                    //设置日期
